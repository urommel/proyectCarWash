    ...
    public function store(Request $request)
{
    ...
    // Recuperar el ID del empleado desde la URL
    $empleado_id = $request->query('empleado');

    // Verificar que el empleado con ese ID existe y está asociado al usuario autenticado si es necesario
