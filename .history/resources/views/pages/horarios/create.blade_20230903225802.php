...
<script>
    function toggleHorarios(checkboxId, horariosId) {
        ...
        // Cambiar el texto y el fondo cuando se selecciona "Descansa"
...
Con estos cambios, cuando se selecciona "Descansa", el texto cambia a "Descansa", el fondo se vuelve gris (como "plomo") y se deshabilitan los campos de entrada de hora correspondientes. Cuando se deselecciona "Descansa", el texto cambia a "Trabaja", el fondo se restablece y los campos de entrada de hora se habilitan nuevamente.
