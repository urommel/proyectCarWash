...
Asegúrate de que el id y el data-horarios-id de los elementos HTML coincidan y de que los nombres de las funciones y los atributos se correspondan en la página HTML.

Con estos cambios, debería funcionar como se espera, cambiando de "Trabaja" a "Descansa" y habilitando/deshabilitando los campos de tiempo según el estado del checkbox.
