                ...
                @foreach ($empleados as $key => $empleado)
                    <tbody>
                        <tr
                            ...
                            <td class="px-6 py-4">
                                <a href="#"
                                    class="font-medium {{ $key % 2 == 0 ? 'text-blue-600' : 'text-blue-500' }} dark:text-blue-500 hover:underline dark:bg-white dark:hover:bg-white dark:text-black dark:focus:ring-white">
