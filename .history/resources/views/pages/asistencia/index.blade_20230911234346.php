                        ...
                        <tr
                            ...
                            <td class="px-6 py-4">
                                <a href="#" class="font-medium
                                    {{ $key % 2 == 0 ? 'text-blue-600 dark:text-blue-500' : 'text-blue-500' }}
                                    hover:underline">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 640 512"
                                        class="transition-transform transform hover:scale-110
                                        {{ $key % 2 == 0 ? 'dark:hover:shadow-lg' : '' }}">
                                        <circle cx="320" cy="256" r="160" fill="white"
                                            class="hidden dark:inline {{ $key % 2 == 0 ? 'hover:shadow-lg' : '' }}" />
